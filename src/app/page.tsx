    ...
    <div className='container items-center space-y-8 md:space-y-4'>
      ...
      <div className='grid grid-cols-2 gap-4'>
        <Link
          ...
          className='bg-primary rounded-md px-4 py-2 text-background font-bold text-center'
        >
          Create a collection
        </Link>
        <Link href='/collection' className='bg-primary rounded-md px-4 py-2 text-background font-bold text-center'>
          Discover
        </Link>
      </div>
    </div>
