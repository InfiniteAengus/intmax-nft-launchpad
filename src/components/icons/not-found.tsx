...
const NotFoundIcon = (props: Props) => (
  <svg width='100%' height='100%' viewBox='0 0 480 360' xmlns='http://www.w3.org/2000/svg' {...props}>
    <defs>
      <linearGradient id='BG' x1='19.496%' x2='77.479%' y1='71.822%' y2='16.69%'>
        <stop offset='0%' stopColor='#beff58' />
        <stop offset='100%' stopColor='#beff58' stopOpacity='0' />
      </linearGradient>
    </defs>
    ...
    <image href='/images/not-found.png' height='300' x='205' y='30' />
    ...
    <defs>
      ...
      >
        <stop stopColor='#beff58' />
        <stop offset='1' stopColor='#beff58' />
      </linearGradient>
    </defs>
  </svg>
);
